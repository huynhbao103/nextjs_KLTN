         ...
         <p className=" text-center text-sm text-brown-primary/70 dark:text-dark-text-secondary">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="group relative flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:bg-gray-800 dark:text-white dark:ring-gray-700 dark:hover:bg-gray-700"
            >
              <span className="absolute inset-y-0 left-0 flex items-center pl-3">
